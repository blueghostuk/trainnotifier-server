USE [natrail]
GO
/****** Object:  Table [dbo].[Tiploc]    Script Date: 02/08/2013 22:45:47 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[TDArea]    Script Date: 02/08/2013 22:45:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[STPIndicator]    Script Date: 02/08/2013 22:45:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[LiveTrain]    Script Date: 02/08/2013 22:45:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AtocCode]    Script Date: 02/08/2013 22:45:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ScheduleStatus]    Script Date: 02/08/2013 22:45:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ScheduleTrain]    Script Date: 02/08/2013 22:45:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[ScheduleTrain](
	...
	[OriginStopTiplocId] [smallint] NOT NULL,
	[DestinationStopTiplocId] [smallint] NOT NULL,
...
GO
/****** Object:  Table [dbo].[LiveTrainStop]    Script Date: 02/08/2013 22:45:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[LiveTrainCancellation]    Script Date: 02/08/2013 22:45:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[LiveTrainBerth]    Script Date: 02/08/2013 22:45:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Station]    Script Date: 02/08/2013 22:45:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ScheduleTrainStop]    Script Date: 02/08/2013 22:45:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[ScheduleTrainStop](
	...
	[Pass] [time](7) NULL,
	[PublicArrival] [time](7) NULL,
	[PublicDeparture] [time](7) NULL,
	[Line] [nchar](10) NULL,
	[Path] [nchar](10) NULL,
	[Platform] [nvarchar](50) NULL,
...
GO
/****** Object:  ForeignKey [FK_LiveTrainBerth_TDArea]    Script Date: 02/08/2013 22:45:47 ******/
...
GO
/****** Object:  ForeignKey [FK_LiveTrainCancellation_LiveTrain]    Script Date: 02/08/2013 22:45:47 ******/
...
GO
/****** Object:  ForeignKey [FK_LiveTrainStop_LiveTrain]    Script Date: 02/08/2013 22:45:47 ******/
...
GO
/****** Object:  ForeignKey [FK_ScheduleTrain_AtocCode]    Script Date: 02/08/2013 22:45:47 ******/
...
GO
/****** Object:  ForeignKey [FK_ScheduleTrain_ScheduleStatus]    Script Date: 02/08/2013 22:45:47 ******/
...
GO
/****** Object:  ForeignKey [FK_ScheduleTrain_STPIndicator]    Script Date: 02/08/2013 22:45:47 ******/
...
GO
/****** Object:  ForeignKey [FK_ScheduleTrain_Tiploc]    Script Date: 02/08/2013 22:45:47 ******/
...
GO
/****** Object:  ForeignKey [FK_ScheduleTrain_Tiploc1]    Script Date: 02/08/2013 22:45:47 ******/
...
GO
/****** Object:  ForeignKey [FK_ScheduleTrainStop_ScheduleTrain]    Script Date: 02/08/2013 22:45:47 ******/
...
GO
/****** Object:  ForeignKey [FK_ScheduleTrainStop_Tiploc]    Script Date: 02/08/2013 22:45:47 ******/
...
GO
/****** Object:  ForeignKey [FK_Station_Tiploc]    Script Date: 02/08/2013 22:45:47 ******/
